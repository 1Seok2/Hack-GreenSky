...
class Map extends Component {
    ...
    componentDidMount() {
        ...
        script.onload = () => {
            ...
            let options = {
                ...
                center: new window.kakao.maps.LatLng(this.state.latitude, this.state.longitude),
                level: 8
            };
            ...
            this.arrayInfected.map((value) => this.makeMarkerInfected(value.lat,value.lng));
        };
    }
    ...
    makeMarkerMyPos = () => {
        ...
        var markerPosition  = new window.kakao.maps.LatLng(this.state.latitude, this.state.longitude); 
        ...
        var circle = new window.kakao.maps.Circle({
            center : new window.kakao.maps.LatLng(this.state.latitude, this.state.longitude),  // 원의 중심좌표 입니다 
